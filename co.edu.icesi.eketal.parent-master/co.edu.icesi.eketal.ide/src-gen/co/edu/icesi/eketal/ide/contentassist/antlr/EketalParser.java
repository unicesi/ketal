		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNotEventAccess().getGroup_1(), "rule__NotEvent__Group_1__0");
					put(grammarAccess.getAtomEventAccess().getGroup_1(), "rule__AtomEvent__Group_1__0");
					put(grammarAccess.getAttrAccess().getGroup_0(), "rule__Attr__Group_0__0");
					...
					put(grammarAccess.getNotEventAccess().getRightAssignment_1_1(), "rule__NotEvent__RightAssignment_1_1");
					put(grammarAccess.getAttrAccess().getHostgroupAssignment_0_2(), "rule__Attr__HostgroupAssignment_0_2");
					put(grammarAccess.getAttrAccess().getOngroupAssignment_1_2(), "rule__Attr__OngroupAssignment_1_2");
					put(grammarAccess.getAttrAccess().getConditionAssignment_2_1(), "rule__Attr__ConditionAssignment_2_1");
					...
					put(grammarAccess.getRcAccess().getAsyncexAssignment_0(), "rule__Rc__AsyncexAssignment_0");
