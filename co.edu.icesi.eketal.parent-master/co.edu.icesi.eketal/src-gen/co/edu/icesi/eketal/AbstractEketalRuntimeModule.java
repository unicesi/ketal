...
import co.edu.icesi.eketal.parser.antlr.EketalAntlrTokenFileProvider;
import co.edu.icesi.eketal.parser.antlr.EketalParser;
import co.edu.icesi.eketal.parser.antlr.internal.InternalEketalLexer;
import co.edu.icesi.eketal.scoping.EketalScopeProvider;
import co.edu.icesi.eketal.serializer.EketalSemanticSequencer;
import co.edu.icesi.eketal.serializer.EketalSyntacticSequencer;
import co.edu.icesi.eketal.services.EketalGrammarAccess;
import co.edu.icesi.eketal.validation.EketalValidator;
...
public abstract class AbstractEketalRuntimeModule extends DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "co/edu/icesi/eketal/Eketal.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("co.edu.icesi.eketal.Eketal");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("eketal");
	}
	...
	public Class<? extends IGrammarAccess> bindIGrammarAccess() {
		return EketalGrammarAccess.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return EketalSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return EketalSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return EketalAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalEketalLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<InternalEketalLexer> provideInternalEketalLexer() {
		return LexerProvider.create(InternalEketalLexer.class);
	}
	...
	public void configureRuntimeLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalEketalLexer.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	@SingletonBinding(eager=true)
	public Class<? extends EketalValidator> bindEketalValidator() {
		return EketalValidator.class;
	}
	...
	public Class<? extends IJvmModelInferrer> bindIJvmModelInferrer() {
		return EketalJvmModelInferrer.class;
	}
